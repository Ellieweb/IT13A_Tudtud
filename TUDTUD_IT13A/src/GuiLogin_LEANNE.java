 ...
 * @author user
 */
public class GuiLogin_LEANNE extends javax.swing.JFrame {

    /**
     * Creates new form GuiLogin_LEANNE
     */
    public GuiLogin_LEANNE() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiLogin_LEANNE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiLogin_LEANNE().setVisible(true);
            }
        });
    }
